...
@WebServlet(name = "LogeoGoogleAquinoValdez", urlPatterns = {"/authgoogle"})
public class LogeoGoogleAquinoValdez extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            GoogleIdTokenVerifier verifier = new GoogleIdTokenVerifier.Builder(new NetHttpTransport(), new GsonFactory())
                .setAudience(Collections.singletonList("102022303805-v2lfvdkihsd9q7odhv17ldjnfs498oep.apps.googleusercontent.com"))
                .build();
